/*
  ...
  1. User Creation
    - Creates a test user for data association
  ...
  3. Platform Metrics Data
    ...
    - Simulates realistic sales patterns and seasonality
*/

-- First ensure the test user exists
INSERT INTO auth.users (id, email)
VALUES ('e2c3c496-5050-4025-8b1b-7811f68b2e8f', 'test@example.com')
ON CONFLICT (id) DO NOTHING;

-- Create profile for the test user
INSERT INTO public.profiles (id, business_name)
VALUES ('e2c3c496-5050-4025-8b1b-7811f68b2e8f', 'Test Fashion Store')
ON CONFLICT (id) DO NOTHING;
