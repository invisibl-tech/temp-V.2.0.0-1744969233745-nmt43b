/*
  # Implement Data Isolation for Mock Data

  1. Changes
    - Clear existing mock data
    - Re-insert mock data only for pinnkpp@gmail.com
    - Update RLS policies to ensure data isolation
...
-- Insert mock data only for pinnkpp@gmail.com
DO $$
DECLARE
  v_user_id uuid;
